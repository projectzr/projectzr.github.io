        ...
        <h1 class="paddingh1 titulo">Machado de Assis <br><small>o maior autor brasileiro</small></h1>
                ...
                <article class="col-xs-12 col-md-8">
                 <h2 style="display: none">Autor de Destaque</h2>
                    <div class> <img src="img/realismo/machado.jpg" alt="Machado de Assis" class="col-xs-4 col-md-4 descricaoimg2">              
