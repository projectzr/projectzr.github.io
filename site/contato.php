            ...
            <div class="section">
                <div class="row text-left">
                    <article class="col-xs-12 col-md-6 col-lg-6">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin imperdiet suscipit ante ac pulvinar.
                            Cras vel mi ullamcorper, bibendum mi nec, posuere neque. Integer tristique neque metus, ut dapibus
                            est tristique non. Sed eget magna tempor eros bibendum mollis ac nec ligula.</p>
                        <p>Curabitur molestie ipsum et mi rutrum pellentesque. Donec vestibulum diam vitae convallis rhoncus.
                            Curabitur vel porta elit. Nulla vel libero mattis, maximus dolor vel, eleifend tortor. Maecenas
                            fringilla nisi in vulputate hendrerit.</p>
                        <p>Praesent gravida posuere ante, id molestie tellus sollicitudin in. Sed sit amet lacus porttitor,
                            maximus lacus nec, consectetur orci. Nam facilisis vulputate rutrum. Pellentesque non dui vitae
                            lectus finibus porttitor. </p>
                    </article>
