...
<body>
    ...
    $linkb="realismo-contexto-historico.php";
        ...
        <div class="container section" id="conteudo">
            <div class="row text-left">
                ...
                <article class="col-xs-12 col-md-8">
                    <h2 style="display: none">Autor de Destaque</h2>
                    <img src="img/realismo/machado.jpg" alt="Machado de Assis." class="col-xs-4 col-md-4 descricaoimg2">
                    ...
                    <p class="pararealismo">Proin id elit et leo fringilla dictum sit amet non quam. Cras fringilla in justo sed placerat. Interdum et malesuada fames ac ante ipsum primis in faucibus. Integer ac ante in erat feugiat rutrum vitae vulputate risus. Mauris nec tincidunt sem, a cursus justo. Pellentesque venenatis erat in felis blandit, in auctor enim semper. Morbi non tellus sit amet arcu scelerisque eleifend.Aliquam ut vestibulum felis. Aliquam erat volutpat. Nam euismod vel eros vitae elementum. Aliquam dapibus, quam vel fermentum aliquam, libero tellus facilisis eros, non suscipit velit enim vitae mi. </p>
                    <p class="pararealismo">Ut fermentum urna at elit sagittis viverra. Duis quis felis euismod elit aliquet semper nec a elit. Suspendisse convallis blandit aliquam. Nunc vitae elementum libero. Aliquam porttitor in nibh id commodo. Proin luctus metus nulla, sed gravida tortor egestas tristique. Duis tincidunt tortor eu feugiat pretium. Praesent ultrices nunc ut enim sagittis, eget sagittis purus porta. Donec nec viverra neque. Nulla ac ex at nulla ornare eleifend.Aliquam porttitor in nibh id commodo. Proin luctus metus nulla, sed gravida tortor egestas tristique. </p>
                    <p class="pararealismo">Vestibulum vulputate turpis nec suscipit interdum. Donec a nunc sodales, gravida lorem sed, vestibulum sem. Duis ligula nisl, commodo rhoncus tempor quis, euismod et arcu. Cras non consequat leo. Cras vel lacus sed leo rhoncus ornare a et ipsum. Cras lobortis massa non leo porttitor, non commodo purus hendrerit. Morbi a auctor tellus.Vivamus mattis pharetra erat, id malesuada lacus sodales quis. Proin id elit et leo fringilla dictum sit amet non quam. Vestibulum vulputate turpis nec suscipit interdum. Donec a nunc sodales, gravida lorem sed, vestibulum sem. Duis ligula nisl, commodo rhoncus tempor quis, euismod et arcu. Cras non non commodo.</p>
                </article>
                <aside class="col-xs-12 col-md-4 sombra">
                    <h3 class="sub-titulo text-center">Memórias Póstumas de Brás Cubas, o marco do realismo brasileiro</h3>
                    <div class="realismodivisor hidden-lg hidden-md"></div>
                    <img src="img/realismo/obra.JPG" alt="Capa do Livro Memórias Póstumas de Brás Cubas" class="col-xs-4 col-md-8 memoriasimg">
