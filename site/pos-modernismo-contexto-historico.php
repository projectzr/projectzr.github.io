        ...
        <div class="section container" id="conteudo">
            ...
            <article class="col-xs-12">
                ...
                <div class="coluna-esquerda col-md-6">
                    ...
                    <p class="text-justify mid-space ">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut, iste molestias? Fugit quisquam corporis repellendus eligendi inventore tempora vero sapiente minus quaerat magni magnam suscipit quia quod, assumenda saepe voluptatibus totam nulla ducimus labore. Magni!</p>
                </div>

                <div class="coluna-direita col-md-6">
                    <div id="spacer"></div>
                    <p class="titulo title-left text-justify mid-space line-correction">O Pós-Modernismo</p>
                    <p class="text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut, iste molestias? Fugit quisquam corporis repellendus eligendi inventore tempora vero sapiente minus quaerat magni magnam suscipit quia quod, assumenda saepe voluptatibus totam nulla ducimus labore. Magni!</p>
                    <p class="mid-space text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut, iste molestias? Fugit quisquam corporis repellendus eligendi inventore tempora vero sapiente minus quaerat magni magnam suscipit quia quod, assumenda saepe voluptatibus totam nulla ducimus labore. Magni! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat cum minima provident impedit mollitia nobis soluta debitis illo, ex iure ducimus, deserunt dolorum esse sed totam nulla ducimus labore. Magni!</p>
                </div>
            </article>
