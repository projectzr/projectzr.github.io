        ...
        <h1 class="paddingh1 titulo">Machado de Assis, o maior autor brasileiro</h1>
                <article class="col-xs-12 col-md-8">
                    <div class> <img src="img/machado.jpg" alt="Machado de Assis" class="col-xs-4 col-md-4 descricaoimg2">
                        ...
                        <p class="pararealismo">Vestibulum vulputate turpis nec suscipit interdum. Donec a nunc sodales, gravida lorem sed, vestibulum sem. Duis ligula nisl, commodo rhoncus tempor quis, euismod et arcu. Cras non consequat leo. Cras vel lacus sed leo rhoncus ornare a et ipsum. Cras lobortis massa non leo porttitor, non commodo purus hendrerit. Morbi a auctor tellus. </p>
   <p class="pararealismo">Vestibulum vulputate turpis nec suscipit interdum. Donec a nunc sodales, gravida lorem sed, vestibulum sem. Duis ligula nisl, commodo rhoncus tempor quis, euismod et arcu. Cras non.</p>
                    </div>
                </article>
