...
<body>
    ...
    <!-- Header
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <?php $titulo='Simbolismo'; $subtitulo='Principais Obras'; include 'includes/section-header.php'; ?>

      <?php 
    $nomea="Contexto Histórico";
    $linka="simbolismo-contexto-historico.php";
...
<svg width= 20em height= 3em x="0px" y="0px"
	 viewBox="0 0 140 25.1" style="enable-background:new 0 0 140 25.1;">
<style type="text/css">
	.st0{fill:#c6c1d7;}
</style>
<g>
