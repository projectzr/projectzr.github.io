<article class="container section">
    <div class="row text-left">
        <div class="col-xs-12 mp-mapa">
            ...
            <div class="col-xs-12 col-md-6 col-lg-4 mp-institucional">
                <h4> Intitucional <span class="caret"></span></h4>
                <ul>
                    <li><a class="mp-link" href="quem-somos.php">Quem somos</a></li>
                    <li><a class="mp-link" href="dicas-de-vestibular.php">Dicas de Vestibular</a></li>
                    <li><a class="mp-link" href="academia.php">Academia Brasileira de Letras</a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-md-6 col-lg-4 mp-institucional">
                ...
                <ul>
                    ...
                    <li><a class="mp-link" href="mapa.php">Mapa do Site</a></li>
                    <li><a class="mp-link" href="normas.php">Normas de Utilização</a></li>
                    <li><a class="mp-link" href="index.php">Home</a></li>
                </ul>
            </div>
        </div>
    </div>
